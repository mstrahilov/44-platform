...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: "/assets", destination: "/store/assets", permanent: true },
      { source: "/assets/discover", destination: "/store/assets", permanent: true },
      { source: "/assets/store", destination: "/store/assets", permanent: true },
      ...
      { source: "/store/:category(music|books|assets|merch|games)/:slug", destination: "/store/item/:slug", permanent: true },
