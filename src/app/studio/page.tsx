  ...
  if (profile && !isCreatorProfile(profile)) {
    return (
      <div className="panel-scroll">
        <SystemPanel tabs={[{ id: 'studio', label: 'Studio' }]} avatar={initials}>
          {() => (
            <div className="settings-section">
              ...
              <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap' }}>
                <Link href="/profile" className="os-button os-button-primary">Open Profile</Link>
          ...
          <>
            ...
            {tab === 'posts' && (
              <div>
                ...
                <p className="os-type-body" style={{ color: 'var(--os-color-ink-secondary)', marginBottom: 18 }}>
                  Write updates, announcements, and community posts without leaving Studio.
                </p>
                <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap' }}>
