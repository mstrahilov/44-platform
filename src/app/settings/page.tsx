  ...
  return (
    <div className="settings-section">
      <div className="settings-block">
        ...
        <p className="os-type-body">Manage your email, password, and session.</p>
        {user?.email && (
      ...
      <div className="settings-field">
        <div className="settings-field-head">
          <div className="os-type-card-title">Session</div>
          <p className="os-type-body-small">Sign out of this device.</p>
        </div>
        <div>
          <button className="os-button os-button-ghost" type="button" onClick={handleSignOut} disabled={signingOut}>
...
function PrivacySettings() {
  return (
    <div className="settings-section">
      <div className="settings-block">
        <h2 className="os-type-panel-title">Privacy</h2>
        <p className="os-type-body">Manage your visibility and a few comfort-level settings. These choices are saved on this device for now.</p>
      </div>
      <div>
...
function SecuritySettings() {
  return (
    <div className="settings-section">
      <div className="settings-block">
        <h2 className="os-type-panel-title">Security</h2>
        <p className="os-type-body">Additional security options for your account.</p>
...
function ConnectedApps() {
  return (
    <div className="settings-section">
      <div className="settings-block">
        <h2 className="os-type-panel-title">Connected Apps</h2>
        <p className="os-type-body">Keep track of the integrations you want active. These are visual toggles for now.</p>
      </div>
      <div>
        <ToggleRow storageKey={SETTINGS_KEYS.stripe} title="Stripe" desc="Payouts and creator earnings." />
        <ToggleRow storageKey={SETTINGS_KEYS.paypal} title="PayPal" desc="Alternative payout method." />
        <ToggleRow storageKey={SETTINGS_KEYS.discord} title="Discord" desc="Link your Discord account." />
        <ToggleRow storageKey={SETTINGS_KEYS.google} title="Google Drive" desc="Store and access files." />
        <ToggleRow storageKey={SETTINGS_KEYS.dropbox} title="Dropbox" desc="Cloud file storage." />
        <ToggleRow storageKey={SETTINGS_KEYS.github} title="GitHub" desc="Code repositories and version control." />
        <ToggleRow storageKey={SETTINGS_KEYS.figma} title="Figma" desc="Design files and collaboration." />
        <ToggleRow storageKey={SETTINGS_KEYS.spotify} title="Spotify" desc="Show what you're listening to." />
        <ToggleRow storageKey={SETTINGS_KEYS.youtube} title="YouTube" desc="Video content and channel linking." />
      </div>
    </div>
  );
}
...
function DataSettings() {
  return (
    <div className="settings-section">
      <div className="settings-block">
        <h2 className="os-type-panel-title">Data</h2>
        <p className="os-type-body">Export, clear, or remove your data from 44.</p>
      </div>
      ...
      <div className="settings-field">
        ...
        <div>
          <button className="os-button os-button-secondary" type="button" disabled>
            Request Export
          </button>
        </div>
      </div>
      ...
      <div className="settings-field">
        ...
        <div>
          <button className="os-button os-button-ghost" type="button" disabled>
            Clear History
          </button>
        </div>
      </div>
      ...
      <div className="settings-field">
        ...
        <div>
          <button className="os-button os-button-ghost" type="button" disabled style={{ color: '#ff6b6b' }}>
            Delete Account
          </button>
        </div>
      </div>
