...
export function achievementTemplates(sectionId: StudioCatalogSectionId): DraftAchievement[] {
  if (sectionId === 'music') {
    return [
      { code: 'no_skips', title: 'No Skips', description: 'Listen without skipping a single track.', triggerType: 'album_no_skips', enabled: true, iconUrl: getAchievementIconPath('no_skips') },
