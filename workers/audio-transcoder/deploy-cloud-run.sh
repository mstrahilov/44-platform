...
WORKER_SERVICE_ACCOUNT_NAME="${WORKER_SERVICE_ACCOUNT_NAME:-44-audio-worker}"
SCHEDULER_SERVICE_ACCOUNT_NAME="${SCHEDULER_SERVICE_ACCOUNT_NAME:-44-audio-scheduler}"
