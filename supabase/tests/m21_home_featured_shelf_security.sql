...
select throws_ok($$select public.set_admin_home_featured_items(array_fill('98200000-0000-0000-0000-000000000001'::uuid,array[9]),'Too many selections')$$,'22023','Featured supports at most eight Items.','more than eight Featured slots are rejected');
