...
values
 ...
 ('60000000-0000-0000-0000-000000000002','m15-pack','M15 Pack','M15 Creator','Sample Pack',0,true,false,'{}','published','50000000-0000-0000-0000-000000000002','asset','digital',true);
...
select lives_ok($$select public.save_item_to_library('60000000-0000-0000-0000-000000000002')$$,'member can claim the free sample pack');
select ok(public.has_item_entitlement('50000000-0000-0000-0000-000000000001','60000000-0000-0000-0000-000000000002','download'),'free sample-pack claim grants download access');
select ok(public.can_access_item_file('products/assets/50000000-0000-0000-0000-000000000002/pack.zip'),'download entitlement authorizes the full pack');
select ok(public.can_access_item_file('products/assets/50000000-0000-0000-0000-000000000002/kick.wav'),'download entitlement authorizes an individual sample');
