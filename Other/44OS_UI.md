...
- The reader uses the Safari-compatible PDF.js client/worker path and supplies the Map upsert compatibility required by older iOS/WebKit versions, while keeping pinch zoom and the established reader controls unchanged.
