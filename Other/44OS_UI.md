...
- The immersive reader/interactive shell follow-up is deployed in production through `https://44-platform-e9yp4065n-44os.vercel.app`, aliased to `https://44os.com`. Local rendered acceptance covered 1440×900 and 390×844, and the post-deployment launch smoke passed.
...
- Library item detail pages use one primary format action: Music shows Play, Books show Read, and Sample Packs show Download. Book and Sample Pack pages do not show View Creator as a second hero action, Library music pages do not show Shuffle, and closing the PDF reader must return to the originating Item detail without making the shell Back control reopen the reader.
